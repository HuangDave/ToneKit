...
kernel void compute_overlay_blend(texture2d<float, access::sample> input_texture   [[texture(0)]],
                                  ...
                                  uint2 gid [[thread_position_in_grid]])
{
    ...
    float4 output_color = float4(a.r < 0.5 ? (2.0 * a.r * b.r) : (1.0 - 2.0 * (1.0 - a.r) * (1.0 - b.r)),
